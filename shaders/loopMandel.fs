...
void main(){
	...
	//
  FragColor =vec4(vec3(Mandel(double(-.4621603)+double(FragCoord.x*2.0)/double(pow(2.,10*(1+sin(.2*Time-3.1415*0.5)))),double(-.5823998)+double(FragCoord.y*2.0)/double(pow(2.,10*(1+sin(.2*Time-3.1415*0.5)))))),1.);//vec2(-.4621603,-.5823998)+FragCoord*2.0/pow(2,Time))),1.);//vec2(.3885959955,.133913)
